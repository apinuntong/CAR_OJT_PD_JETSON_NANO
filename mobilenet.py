...
def get_mobilenet_encoder( input_height=128 ,  input_width=128 , pretrained='imagenet' ):
  ...
  assert ( input_height == 128 ), "For mobilenet , 224 input_height is supported "
  assert ( input_width == 128 ), "For mobilenet , 224 width is supported "
  ...
  if pretrained == 'imagenet' :
    model_name = 'mobilenet_%s_%d_tf_no_top.h5' % ( '7_5' , 128 )
